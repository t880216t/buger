...
export default class Header extends Component {
  ...
  goAddPage=()=>{this.props.dispatch(NavigationActions.navigate({routeName:'AddPage'}))}
  ...
  renderListFooter=()=>(
      <View style={{height:50, padding:10}}>
        <Text style={{textAlign:'center'}}>No More...</Text>
      </View>
    )
  ...
  render() {
    const sidebar = (
      <ScrollView style={styles.side_container}>
        ...
        <TouchableOpacity style={styles.side_item} onPress={()=>this.setState({libModalVisible:!this.state.libModalVisible})}>
          <Image
        ...
        <TouchableOpacity style={styles.side_item} onPress={()=>this.setState({aboutMeModalVisible:!this.state.aboutMeModalVisible})}>
          <Image
        ...
        <TouchableOpacity style={styles.side_item} onPress={()=>{this.handlelogout()}}>
          <Image
      ...
      >
        ...
        >
          <ScrollView style={{padding:10,maxHeight:400}}>
            ...
            <Text style={{fontSize:14,color:'blue'}} onPress={()=>Linking.openURL('https://docs.atlassian.com/DAC/rest/jira/6.1.html')}>
              https://docs.atlassian.com/DAC/rest/jira/6.1.html
            </Text>
            <Text style={{fontSize:16,color:'#000',marginTop:10}}>React Native</Text>
            <Text style={{fontSize:14,color:'blue'}} onPress={()=>Linking.openURL('http://facebook.github.io/react-native')}>
            ...
            <Text style={{fontSize:14,color:'blue'}} onPress={()=>Linking.openURL('https://github.com/dvajs/dva/blob/master/README_zh-CN.md')}>
            ...
            <Text style={{fontSize:14,color:'blue'}} onPress={()=>Linking.openURL('https://rn.mobile.ant.design/index-cn')}>
              https://rn.mobile.ant.design/index-cn
            </Text>
            <Text style={{fontSize:16,color:'#000',marginTop:10}}>react-native-dva-starter</Text>
            <Text style={{fontSize:14,color:'blue',marginBottom:10}} onPress={()=>Linking.openURL('https://github.com/nihgwu/react-native-dva-starter')}>
